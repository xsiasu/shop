      ...
      <div class="w-size6 p-t-30 p-l-15 p-r-15 respon3">
        ...
        <div>
          ...
          <div class="flex-m p-t-30">
            <a href="#" class="fs-18 color1 p-r-20 fa fa-facebook" />
            <a href="#" class="fs-18 color1 p-r-20 fa fa-instagram" />
            <a href="#" class="fs-18 color1 p-r-20 fa fa-pinterest-p" />
            <a href="#" class="fs-18 color1 p-r-20 fa fa-snapchat-ghost" />
            <a href="#" class="fs-18 color1 p-r-20 fa fa-youtube-play" />
          </div>
        </div>
      </div>
